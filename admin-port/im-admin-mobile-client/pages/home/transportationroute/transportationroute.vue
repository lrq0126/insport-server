                                    ...
                                    <view class="package_C_C">
                                        ...
                                        <p class="package_C_C_P">
                                            <text>
                                                ...
                                                <text style="color: red;font-weight: bold;" v-if="item.routeType == 1">空运</text>
                                                <text style="color: red;font-weight: bold;" v-else>海运</text>
                                            </text>
                                        </p>
                                        <p>
                                        ...
                                        <p>
                                            <text class="package_C_C_T" style="width: 100px;">预计送达时间：</text> {{item.transportationTime}}
                                        </p>
                                        <p>
...
export default {
    ...
    methods: {
        ...
        */
        ...
        handleSearch () {
            this.showloading()
            transportChannelsList(this.pageInfo).then(res => {
    ...
    mounted () {
		this.pageInfo.countryId = uni.getStorageSync("info").countryId
		this.handleSearch();
    }
}
</script>
