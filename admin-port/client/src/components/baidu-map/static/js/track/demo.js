 ...
 * @Last Modified by: zhufuxing
 * @Last Modified time: 2019-06-06 09:15:33
 */
/**
 * 通用函数模块
 * @Author: xuguanlong
...
define('track/demo', ['track/urls', 'track/message', 'track/track', 'track/draw', 'track/util', 'track/Timeline'], function (urls, message, trackModule, drawModule, Util, timeLineControl) {
    ...
    return {
        ...
        getTraceDetail: function () {
            ...
            tip.hide();
            urls.get('http://shortbaby.github.io/yingyan/static/data/trace.json', params, sucCbk);
        },
        // 实时监控加载数据
        loadData: function (pageIndex, before, after) {
            ...
            tip.hide();
            urls.get('http://shortbaby.github.io/yingyan/static/data/list.json', params, function (res) {
                if (res.status === 0) {
