...
<template>
    <div class="cargo-list-model-view">
        <!--编辑信息 -->
        <el-dialog :visible.sync="dialogListInfo"
            ...
            <el-table :data="tableData"
                ...
                <el-table-column fixed="right"
                    ...
                    <template slot-scope="scope">
                        ...
                        <el-tag v-if="scope.row.goodsType == 2"
                                type="success">出库</el-tag>
                        <el-tag v-if="scope.row.goodsType == 3"
                                type="warning">预录入</el-tag>
                    </template>
                </el-table-column>
            ...
            <span slot="footer"
                ...
                <el-button v-waves
                           type="info"
                           plain
                           @click="dialogListInfo = false">关 闭</el-button>
                <!-- <el-button v-waves
                           type="primary"
        ...
        <!--客户列表信息 -->
        <el-dialog :visible.sync="dialogCustomerInfo"
                   :closeOnClickModal="false"
                   title="客户信息"
                   class="dialog-box"
                   width="80%">
            ...
            <el-form ref="searchForm"
                ...
                <el-form-item>
                    <el-button type="primary"
                               @click="handCustomerInfoModel(1)">查询</el-button>&nbsp;
            ...
            <span slot="footer"
                ...
                <el-button v-waves
                           type="info"
                           plain
                           @click="dialogCustomerInfo = false">关 闭</el-button>
                <!-- <el-button v-waves
                           type="primary"
                           @click="handleSubmit('form')">提 交</el-button> -->
            </span>
