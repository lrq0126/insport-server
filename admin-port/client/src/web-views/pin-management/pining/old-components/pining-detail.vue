...
<template>
  <div class="pining-detail">
    ...
    >
      <el-tab-pane label="未成团订单明细" name="list">
      ...
      <el-form>
        <el-form-item label-width="42%">
          <!-- <el-button
              ...
              > -->
          <el-button :loading="saving" type="success" @click="handleSubmit"
            >确认成团</el-button
          >
...
export default {
  ...
  methods: {
    ...
    handleSubmit() {
      completeTeamComplete(this.formItem.id).then((res) => {
        if (res.code == 100) {
          this.$message({
            message: "拼团成功",
            type: "success",
