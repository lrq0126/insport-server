...
<template>
  <div class="complete-pin-detail">
    ...
    >
      <el-tab-pane label="已付款拼团订单详情" name="list">
        <el-divider content-position="left">
          <i class="el-icon-mobile-phone"></i>拼团详情</el-divider
        >
        <div>
