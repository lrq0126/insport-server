    ...
    <div>
        ...
        <el-form ref="searchForm"
            ...
            <el-form-item>
                ...
                <el-button type="info"
                           plain
                           @click="handleResetForm('searchForm')">导 入</el-button>
                <el-button type="info"
                           plain
                           @click="handleResetForm('searchForm')">下载模板</el-button>
            </el-form-item>
        </el-form>
            ...
            <el-table-column width="120"
                ...
                <template slot-scope="scope">
                    <el-button type="primary"
                               size="mini"
                               plain
                               @click="handleCheck(scope.row.jobId)"
                               :disabled="scope.row.roleCode != 'all' && hasAuthority('systemRoleEdit')?false:true">查 看</el-button>
                </template>
            </el-table-column>
