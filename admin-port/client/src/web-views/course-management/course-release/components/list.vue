            ...
            <el-table-column label="操作"
                ...
                <template slot-scope="scope">
                    <el-button type="primary"
                               ...
                               :disabled="scope.row.roleCode != 'all' && hasAuthority('systemRoleEdit')?false:true">排课</el-button>
                    <el-button type="success"
                               size="mini"
                               plain
                               @click="handleRelease(scope.row.jobId)"
                               :disabled="scope.row.roleCode != 'all' && hasAuthority('systemRoleEdit')?false:true">发布</el-button>
                    <!-- <el-button type="info"
                               size="mini"
                               plain
