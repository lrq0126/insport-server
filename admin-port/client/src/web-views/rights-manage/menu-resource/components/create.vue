    ...
    <el-form ref="ruleForm" label-width="200px" class="demo-ruleForm">
      <el-row style="margin-top: 50px;">
        <el-col :span="20">
          <el-row :gutter="20">
            <el-col :span="8">
              <el-form-item label="归属菜单：" prop="column">
        ...
        <el-col :span="20">
          <el-row :gutter="20">
            <el-col :span="8">
              <el-form-item label="名称：" prop="column">
        ...
        <el-col :span="20">
          <el-row :gutter="20">
            <el-col :span="8">
              <el-form-item label="图标：" prop="column">
        ...
        <el-col :span="20">
          <el-row :gutter="20">
            <el-col :span="8">
              <el-form-item label="系统标识：" prop="column">
                <el-input placeholder="请输入系统标识"></el-input>
              </el-form-item>
            </el-col>
          </el-row>
        </el-col>
