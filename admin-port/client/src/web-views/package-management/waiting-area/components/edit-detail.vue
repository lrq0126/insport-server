      ...
      waitingAreaDetail(businessNumber)
        .then((res) => {
          if (res.code === 100) {
            ...
            this.formItem.countryId = res.content.customerPack.routeVo.countryId;
            ...
            this.formItem.isInsurance = res.content.customerPack.routeVo.isInsurance;
            this.formItem.isTariffs = res.content.customerPack.routeVo.isTariffs;
            this.formItem.tariffs = res.content.customerPack.routeVo.tariffs;

            this.formItem.packValuations = res.content.customerPack.packValuations;
            ...
            //   pack.packagesInfo =
            //     res.content.customerPack.customerPackNumbers[pingPackIndex].goodsVoList;
            //   pack.goodsIds = "";
            //   res.content.customerPack.customerPackNumbers[pingPackIndex].goodsVoList.forEach((goods) => {
            //     pack.goodsIds = pack.goodsIds == "" ? goods.id : pack.goodsIds + "," + goods.id;
            //   });
