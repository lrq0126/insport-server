    ...
    <div>
        ...
        <el-table :data="tableData"
            ...
            <el-table-column prop="couponsAmount"
                             ...
                             align="center">
                             <template slot-scope="scope">
                                <span v-if="scope.row.couponsAmount">{{scope.row.couponsAmount}}</span>
                                <span v-else>/</span>
                            </template>
            </el-table-column>    
...
import { getWaitingArea, comfirmWaitingArea, cancelUnpackingWaitingArea,comfirmOrderVoided } from '@/api/package-management/waiting-area'
