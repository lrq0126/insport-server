...
<template>
    <div class="tab-container">
        <el-tabs v-model="activeName"
            ...
            <!-- <el-tab-pane label="待发货列表"
                         name="confirmedList">
                <keep-alive>
                    <confirmed-list-pane ref="confirmedListPane"
                               :notice-types="noticeType"
                               :hiddendanger-statusdata="hiddendangerStatus" />
                </keep-alive>
            </el-tab-pane> -->
...
// import confirmedListPane from './components/confirmed-list'
    ...
    methods: {
        ...
        */
        ...
        handTabClick (data) {
            ...
            // else if(data.name === 'confirmedList'){
            //     this.$refs['confirmedListPane'].handleSearch();
            // }
        }
    },
    mounted () {
