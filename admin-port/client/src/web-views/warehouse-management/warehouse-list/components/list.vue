    ...
    <div>
        ...
        <el-form ref="searchForm"
            ...
            <el-form-item label="仓库区">
                <el-input type="text"
                          v-model="pageInfo.storageArea"
                          placeholder="请输入仓库区" />
            </el-form-item>

            <el-form-item label="仓库排">
                <el-input type="text"
                          v-model="pageInfo.storageRow"
                          placeholder="请输入仓库排" />
            </el-form-item>
        ...
        <el-table :data="tableData"
            ...
            <el-table-column prop="storageRow"
                             label="仓库排"
                             min-width="160"
                             align="center"></el-table-column>
            ...
            <el-table-column label="操作"
                ...
                <template slot-scope="scope">
                    <el-button v-if="filterPermissions('修改仓库区域')"
                               ...
                               size="mini"
                               plain
                               @click="handlePringt(scope.row)"
                               :disabled="scope.row.roleCode != 'all' && hasAuthority('systemRoleEdit')?false:true">打印</el-button>
                    <el-button v-if="filterPermissions('修改仓库区域')"
                               type="info"
                               size="mini"
                               plain
                    ...
                    <el-button v-if="filterPermissions('删除仓库区域')"
                               ...
                               size="mini"
                               plain
                               @click="handleRemove(scope.row.storageCode)"
...
import { getWarehouseList, removeWarehouseList,printWarehouse } from '@/api/warehouse-management/warehouse-list'
    ...
    methods: {
       ...
       */
        handleSearch (page) {
            ...
            this.loading = true
            getWarehouseList(this.pageInfo).then(res => {
        ...
        */
        handleResetForm (form) {
            this.pageInfo.storageArea = ''
            this.pageInfo.storageRow = ''
        ...
        handleRemove (id) {
            ...
            this.$confirm('确定删除吗？', '提示', {
                ...
                removeWarehouseList(obj).then(res => {
                    if (res.code === 100) {
                        this.pageInfo.page = 1
                        this.$message({
                            message: "删除成功",
