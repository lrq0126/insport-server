    ...
    <div>
        ...
        <el-form ref="searchForm"
            ...
            <el-form-item label="年级"
                          prop="roleCode">
                <el-select v-model="pageInfo.grade"
                           placeholder="请选择"
                           class="filter-item">
                    <el-option label=" 一年级"
                               value="1"></el-option>
            ...
            <el-form-item label="班级："
                          prop="roleCode">
                <el-select v-model="pageInfo.class"
                           placeholder="请选择"
                           class="filter-item">
                    <el-option label="（1）班"
                               value="1"></el-option>
...
import { getClassManage, getClassManageDetail, removeClassManage } from '@/api/basic-info'
    ...
    methods: {
       ...
       */
        handleSearch (page) {
            ...
            this.loading = true
            getClassManage(this.pageInfo).then(res => {
        ...
        */
        ...
        handleModal (id) {
            if (id) {
                this.saving = true
                getClassManageDetail(id).then(res => {
                    if (res.code === 0) {
