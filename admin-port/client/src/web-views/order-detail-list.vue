<template>
    <div>
        ...
        <el-table :data="tableData" border v-loading="loading" style="width: 100%">
            ...
            <el-table-column label="转单号" align="center" prop="transitNumber" width="170px"/>
            <el-table-column label="国家" align="center" prop="destination" width="170px"/>
            <el-table-column label="渠道" align="center" prop="routeName" width="170px"/>
