<template>
  <div>
    <el-dialog :visible.sync="topUpDetailDialog" title="历史充值记录" width="80%" append-to-body>
        ...
        <el-table :data="tableData" border style="width: 100%">
            ...
            <el-table-column align="center" label="充值渠道" prop="channel">
            ...
            <el-table-column align="center" label="操 作">
                <template slot-scope="scope">
                    <el-button type="success" @click="openHistoryTopUp(scope.row.id)">查看历史充值</el-button>
                </template>
            </el-table-column>
        </el-table>
        <pagination
...
import { getCustomerTopUpHistory } from "@/api/home";
export default {
    components:{
         Pagination
    },
    ...
    methods: {
        ...
        handleSearch(page){
            ...
            getCustomerTopUpHistory(this.pageInfo).then((res) => {
                this.loading = true;
                if(res.code == 100){
