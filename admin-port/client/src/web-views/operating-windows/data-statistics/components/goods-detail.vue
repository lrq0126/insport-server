<template>
  <div>
    <el-dialog :visible.sync="goodsDialog" width="80%" title="货物详情">
        <el-form inline label-width="100px">
            ...
            <el-form-item label="快递单号">
                <el-input v-model="pageInfo.deliveryOrderNo" @keyup.enter.native="handleSearch(1)"/>
            </el-form-item>
        ...
        <el-table :data="tableData" border v-loading="loading" style="width: 100%">
            ...
            <el-table-column label="快递单号" align="center" prop="deliveryOrderNo" width="200px"/>
...
import { getLastDayGoodsDetail } from "@/api/home";
...
export default {
    ...
    methods: {
        ...
        handleSearch(page){
            ...
            getLastDayGoodsDetail(this.pageInfo).then((res) => {
                this.loading = true;
                if(res.code == 100){
