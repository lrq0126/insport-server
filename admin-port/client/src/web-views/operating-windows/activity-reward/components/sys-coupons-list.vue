...
<template>
  <div>
    <el-dialog :visible.sync="sysCouponsDialog" append-to-body width="80%">
      <!-- 搜索 -->
      ...
      >
        ...
        >
          <template slot-scope="scope">
            <el-tag v-if="scope.row.isExchange == 1" type="primary">是</el-tag>
        ...
        >
          <template slot-scope="scope">
            <span v-if="scope.row.overdueType == 1">{{
              scope.row.timeOverdue
            }}</span>
            <span v-if="scope.row.overdueType == 2">{{
              scope.row.timeLimit
            }}</span>
          </template>
        </el-table-column>
