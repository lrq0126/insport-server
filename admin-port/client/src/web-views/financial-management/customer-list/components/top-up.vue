                        ...
                        <el-row style="margin-top: 50px;">
                            ...
                            <el-col :span="20">
                                <el-form-item label="是否发送消息："
                                              prop="ifsend">
                                    <el-radio v-model="formItem.ifsend"
                                               label="1"
                                              >是</el-radio>
                                    <el-radio v-model="formItem.ifsend"
                                               label="0"
                            ...
                            <el-col :span="20">
                                <el-form-item label="消息推送：">
                                    <el-input v-model="formItem.noticeMessage"
                                              type="textarea"
                                              :rows="4"
                                              placeholder="消息推送"
                                              style="width: 300px;"></el-input>
    ...
    data () {
        ...
        return {
            ...
            formItem: {
                ...
                message: '',
                loginName: '',
                noticeMessage: '已充值成功，如需发货，请进入个人中心点击付款发货按钮哦，确认后才会安排发货~',
                ifsend: '1',
            },
            formItemRules: {
                amount: [
        ...
        handleSearch (id) {
            getCustomerListDetail(id).then(res => {
                if (res.code === 100) {
                    ...
                    this.formItem.customerRemarks = res.content.customer.customerRemarks
