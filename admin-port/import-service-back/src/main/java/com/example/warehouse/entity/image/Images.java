package com.example.warehouse.entity.image;
...
public class Images implements Serializable {
    ...
    @Override public boolean equals(Object that) {
        ...
        return (this.getId() == null ? other.getId() == null : this.getId().equals(other.getId())) && (
            ...
            && (this.getPath() == null ? other.getPath() == null : this.getPath().equals(other.getPath())) && (this.getSortNo() == null ? other.getSortNo() == null :
            this.getSortNo().equals(other.getSortNo())) && (this.getImageName() == null ? other.getImageName() == null :
            this.getImageName().equals(other.getImageName())) && (this.getImageSize() == null ? other.getImageSize() == null : this.getImageSize().equals(other.getImageSize()))
