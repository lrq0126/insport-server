package com.example.warehouse.mapper.customerPackReceiverAddress;
...
public interface CustomerPackReceiverAddressDao {
    ...
    int updateOrderReceiverAddress(CustomerPackReceiverAddress customerPackReceiverAddress);
