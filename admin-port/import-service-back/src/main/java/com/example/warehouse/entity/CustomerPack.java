...
public class CustomerPack implements Serializable {
    ...
    private String insideMessage; // 内部消息

    private int accepted; // 未受理 0 已受理 1 已拣货成功 2

    private String acceptedTime; // 订单受理时间

    private String pickedTime; // 已拣货时间

    private Integer isSensitive; // 是否敏感货物 1是 0否

    private BigDecimal tariffsPrice; // 预付关税金额

    private BigDecimal insurancePrice; // 保险金额

    private String postCode; // 邮编，API创建订单时用到

    private String state; // 州，API创建订单时用到

    private String city; // 城市，API创建订单时用到
