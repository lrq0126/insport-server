 ...
 * @author
 */
@ApiModel(value = "RoutePrice",description = "渠道的具体价格明细")
@Data
public class RoutePrice implements Serializable {
     ...
     * 路线类型 1、空运  2、海运
     */
    @ApiModelProperty(value = "路线类型 1、空运  2、海运",name = "routeType")
    private Integer routeType;

    /**
     * 计算类型  1、重量  2、体积
     */
    @ApiModelProperty(value = "计算类型  1、重量  2、体积",name = "countType")
    private Integer countType;

    /**
     * 起始重量 （按照大于计算）
     */
    @ApiModelProperty(value = "起始重量 （按照大于计算）",name = "startWeight")
    private Double startWeight;

    /**
     * 结尾重量（按照小于等于）
     */
    @ApiModelProperty(value = "结尾重量（按照小于等于）",name = "endWeight")
    private Double endWeight;

    /**
     * 起始体积（按照大于计算）
     */
    @ApiModelProperty(value = "起始体积（按照大于计算）",name = "startVolume")
    private Double startVolume;

    /**
     * 结束体积（按照小于等于）
     */
    @ApiModelProperty(value = "结束体积（按照小于等于）",name = "endVolume")
     ...
     * 价格代码
     */
    @ApiModelProperty(value = "价格代码",name = "priceNo")
    private String priceNo;

    /**
     * 小包裹重量
     */
    @ApiModelProperty(value = "小包裹重量",name = "smallPackageWeight")
    private Double smallPackageWeight;

    /**
     * 备注
     */
    @ApiModelProperty(value = "渠道的特殊备注",name = "remarks")
    private String remarks;

    /**
     * 重量进位类型 1、大于0进0.5   2、大于0进1
     */
    @ApiModelProperty(value = "重量进位类型 1、大于0进0.5   2、大于0进1",name = "weightCarryType")
    private Integer weightCarryType;

    /**
     * 大于这个重量需要 叉车费
     */
    @ApiModelProperty(value = "大于这个重量需要 叉车费",name = "greaterWeight")
