...
/**
 * 客户来源表(CustomerFrom)表实体类
 *
 * @author Mr.Wang
 * @version 1.0
 * @since 2022/2/17 9:51
 */
@ApiOperation(value = "客户来源表")
@Data
public class CustomerFrom {
    ...
    public boolean equals(Object that) {
        ...
        CustomerFrom other = (CustomerFrom) that;
        return 
		...
		&& (this.getFromCustomerId() == null ? other.getFromCustomerId() == null : this.getFromCustomerId().equals(other.getFromCustomerId()))
