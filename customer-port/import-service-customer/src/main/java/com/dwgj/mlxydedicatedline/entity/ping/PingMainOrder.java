 ...
 * @author 梁榕清
 * @version 1.0
 * @since 2021/9/8 10:57
 */
@ApiOperation(value = "拼团子订单表")
@Data
public class PingMainOrder {
    ...
    @ApiModelProperty(value = "打包状态：0否，1打包好，2付款完毕，3已发货")
    ...
    @ApiModelProperty(value = "是否拣货，0否，1是")
    ...
    @ApiModelProperty(value = "是否支付，0否1是")
    private Integer isPaid;
    @ApiModelProperty(value = "是否打印清单，0否，1是")
    private Integer isPrinted;
    @ApiModelProperty(value = "收货地址，暂时为空，使用团长的地址")
    ...
    @ApiModelProperty(value = "是否敏感货，0否1是")
