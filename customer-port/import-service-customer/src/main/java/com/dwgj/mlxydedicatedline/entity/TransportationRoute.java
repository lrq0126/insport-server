 ...
 * @author
 */
@ApiModel(value = "TransportationRoute",description = "渠道信息实体类")
@Data
public class TransportationRoute implements Serializable {
     ...
     * 状态  1、正常   0、已删除
     */
    @ApiModelProperty(value = "状态  1、正常   0、已删除",name = "status")
    private Integer status;

    /**
     * 1、启用  0、 禁用
     */
    @ApiModelProperty(value = "启用状态  1、启用  0、 禁用",name = "isAvailable")
     ...
     * 运送方式  1、空运   2、海运   3、其他
     */
    @ApiModelProperty(value = "运送方式  1、空运   2、海运   3、其他",name = "routeType")
    private Integer routeType;

    /**
     * 始发地
     */
    @ApiModelProperty(value = "始发地",name = "originatingPlace",example = "广州")
    private String originatingPlace;

    /**
     * 目的地
     */
    @ApiModelProperty(value = "目的地",name = "destination",example = "美国")
    private String destination;

    /**
     * 英文名称
     */
    @ApiModelProperty(value = "渠道的英文名称",name = "englishName")
     ...
     * 预计运送时间
     */
    @ApiModelProperty(value = "预计运送时间",name = "transportationTime")
    private String transportationTime;

    /**
     * 偏远费用
     */
    @ApiModelProperty(value = "偏远费用",name = "remoteFee")
    private Double remoteFee;

    /**
     * 备注
     */
    @ApiModelProperty(value = "渠道备注信息",name = "remarks")
    private String remarks;

    /**
     * 路线类型 1、空运   2、海运
     */
    @ApiModelProperty(value = "路线类型 1、空运   2、海运",name = "transportType")
    private Integer transportType;

    /**
     * 所属国家
     */
    @ApiModelProperty(value = "所属国家的id",name = "countryId")
    private Integer countryId;

    //TODO  这里添加新的属性

    @ApiModelProperty(value = "渠道的价格明细",name = "routePrices")
    private List<RoutePrice> routePrices;

    private String packAttention;
     ...
     * 是否拼团渠道
     */
    @ApiModelProperty(value = "是否拼团渠道",name = "isPin")
    private int isPin;
