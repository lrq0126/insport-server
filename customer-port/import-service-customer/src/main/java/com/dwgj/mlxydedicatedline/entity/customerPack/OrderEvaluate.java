 ...
 */
@ApiModel(value = "OrderEvaluate",description = "订单评价")
@Data
public class OrderEvaluate  implements Serializable {
	...
	@ApiModelProperty(value = "更新人",name = "updateId",example = "1026")
    private Integer updateId;
	@ApiModelProperty(value = "更新时间",name = "updateTime",example = "2021年1月1日22:20:01")
