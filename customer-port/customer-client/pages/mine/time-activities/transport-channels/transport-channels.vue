        ...
        <!-- <view class="package_stock">
            <form method="post"
                ...
                <button class="package_stock_bu"
                        @click="handleQuerying">查 询</button>
            </form>
        </view> -->
        <!-- 合计 -->
                                    ...
                                    <view class="package_C_T">
                                        <label class="radio"
                                            ...
                                            <radio :checked="index == selectIndex"
                                                   color="#FFCC33"
                                                   style="transform:scale(0.7)" />渠道名称：{{item.routrName}}
                                        </label>
                                    </view>
                                    <view class="package_C_C">
                                        ...
                                        <p class="package_C_C_P">
                                            <text>
                                                ...
                                                <text style="color: red;font-weight: bold;">{{item.transportType}}</text>
                                            </text>
                                            <!-- <text>
                                                <text>预报价： </text>
                                        ...
                                        <p class="package_C_C_P">
                                            ...
                                            <text>运输费用： <text style="color: red;font-weight: bold;">￥{{item.prices}}</text></text>
                                        </p>
                                        <p>
...
import { getactivitiesChannel } from "@/api/mine/time-activities"
    ...
    methods: {
        ...
        */
        ...
        handleSelect () {
            ...
            if (this.selectData) {
                uni.setStorage({
                    key: 'activitiesTransportChannels',
